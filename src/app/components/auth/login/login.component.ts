...
export class LoginComponent implements OnInit {
  ...
  handleLogin() {
      ...
      const data = { "email" : this.loginForm.get('userName').value,
  ...
  submitForm() {
    if (this.registerForm.status === 'VALID') {
      ...
      const find = this.countryWithCode.find(name => name.code === country);
      const registerForm = {
        birthday: this.registerForm.get('birthday').value,
        email: this.registerForm.get('email').value,
        exchangeName: this.registerForm.get('exchangeName').value,
        firstName: this.registerForm.get('firstName').value,
        gender: this.registerForm.get('gender').value,
        lastName: this.registerForm.get('lastName').value,
        password: this.registerForm.get('password').value,
        privacyPolicy: this.registerForm.get('privacyPolicy').value,
        termsAndConditions: this.registerForm.get('termsAndConditions').value,
        username: this.registerForm.get('userName').value,
        referrer: this.registerForm.get('referrer').value,
        country: find
      };
      this.authService.registerUser(registerForm).subscribe((res) => {
        console.log(res);
      });
    }
  }
